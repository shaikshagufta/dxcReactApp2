...
function DataFetching() {
    ...
    */
    ...
    useEffect(
        ...
        [idFromButtonClick] //run this useEffect hook only once ie after component did mount
        //we added idFromButtonClick in it to say- mount everytime the button is clicked 
    )
